...
***************************************************************************/
static int s5k4e1_liteon_add_project_name(struct msm_sensor_ctrl_t *s_ctrl)
{
    ...
    pr_info("%s %d : s5k4e1_liteon_add_project_name sensor_project_name=%s \n",  __func__, __LINE__,
            s_ctrl->sensordata->sensor_info->sensor_project_name);

    /*add the app_info*/
    app_info_set("camera_main", "s5k4e1_liteon");
        
    pr_info("s5k4e1_liteon_add_project_name OK\n");
...
static struct msm_sensor_fn_t s5k4e1_liteon_sensor_func_tbl = {
    ...
    .sensor_add_project_name = s5k4e1_liteon_add_project_name,
#endif
};
