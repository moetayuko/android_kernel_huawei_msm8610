...
static struct msm_sensor_power_setting ov8850_foxconn_power_down_setting[] = {
	{
		.seq_type = SENSOR_I2C_MUX,
		.seq_val = 0,
		.config_val = 0,
...
#ifdef CONFIG_HUAWEI_KERNEL_CAMERA
    .sensor_add_project_name = ov8850_foxconn_add_project_name,
#endif
};
...
#ifdef CONFIG_HUAWEI_KERNEL_CAMERA
	.power_down_setting_array.power_setting = ov8850_foxconn_power_down_setting,
	.power_down_setting_array.size = ARRAY_SIZE(ov8850_foxconn_power_down_setting),
#endif
};
