...
#ifdef CONFIG_HUAWEI_KERNEL_CAMERA
	.power_down_setting_array.power_setting = imx134_sunny_p8n09c_power_down_setting,
	.power_down_setting_array.size = ARRAY_SIZE(imx134_sunny_p8n09c_power_down_setting),
#endif
};
